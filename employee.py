...
def show():
    ...
    try:
        mycursor = mysqldb.cursor()
        mycursor.execute(f"SELECT id,empname,mobile,salary FROM registation WHERE id = '{get_id}'")
...
Button(root, text="Find",command= show,height=3, width=13).place(x=360, y=130)
